...
<a href="/userOld/register">Register</a>
...
<table border=1>
    ...
    <tr>
            ...
            <td><a href="/userOld/edit/<c:out value="${userD.id}"/>">Edit</a></td>
            <td><a href="/userOld/delete?userId=<c:out value="${userD.id}"/>">Delete</a></td>
